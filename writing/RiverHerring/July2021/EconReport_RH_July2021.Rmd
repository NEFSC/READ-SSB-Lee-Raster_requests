...
getCallAreaEffort(raster_folder =
    ...
    shapefile_f = file.path(network_location,"home2/mlee/READ-SSB-Lee-Raster_requests/input_data/RiverHerring/July2021/individual"),
    output_f = file.path(network_location,"home2/mlee/READ-SSB-Lee-Raster_requests/raw_data/RiverHerring/July2021"),
    start = START.YEAR,
    end = END.YEAR)
```
