...
---
<!-- 
This is the markdown document used to make the generic report for the MAMFC River Herring Request.  It uses the offshoreWind package. I didn't get a shapefile from MAFMC, so I am using the Herring FW7 as a placeholder.
