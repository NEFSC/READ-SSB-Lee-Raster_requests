...
FIN <- merge(FIN,GEAR.COMPILED,by.x='IMGID',by.y='GEARID',all.x=TRUE, all.y=FALSE)
if (length(FIN$GEARCODE[is.na(FIN$MESH) & 
          FIN$GEARCODE%in%c("TRAWL-MIDWATER","TRAWL-BOTTOM",
          "GILLNET-SINK","GILLNET-OTHER","SEINE-PURSE","SEINE-OTHER",
          "WEIR-TRAP")])/
          length(FIN$GEARCODE[FIN$GEARCODE%in%c("TRAWL-MIDWATER",
          "TRAWL-BOTTOM","GILLNET-SINK","GILLNET-OTHER","SEINE-PURSE",
          "SEINE-OTHER","WEIR-TRAP")])>0.01) 
